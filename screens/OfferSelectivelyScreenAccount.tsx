...
export type OfferSelectivelyScreenAccountProps = {
  route: {
    params: {
      userId: string;
      itemMatched: Item;
...
const OfferSelectivelyScreenAccount = ({
  navigation,
  route: {
    params: { userId, itemMatched, sellerMatched },
  },
}: OfferSelectivelyScreenAccountProps) => {
...
export default OfferSelectivelyScreenAccount;
